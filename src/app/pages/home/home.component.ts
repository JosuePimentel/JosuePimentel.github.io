...
import { PhotoRoundedComponent } from '../../components/photo-rounded/photo-rounded.component';
import {TooltipPosition, MatTooltipModule} from '@angular/material/tooltip';
import { EventsElementModel } from '../../module/model/events-element.model';

type social = { name: string, link: string, svg: string };
...
export class HomeComponent implements OnInit{
  ...
  eventsElement = new EventsElementModel(this.plataformId);
  quantityPhotosToTake: number = 0;

  constructor() {}

  random(max: number = 1, min: number = 0): number {
